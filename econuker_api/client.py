...
class Client:
    ...
    def __init__(self, auth_token: str = None, beta: bool = False):
        ...
        self.items = ItemsAPI(self.auth_token, self.base_url, self.auth_level)
        self.servers = ServersAPI(self.auth_token, self.base_url, self.auth_level)
        self.auth = AuthAPI(self.auth_token, self.base_url, self.auth_level)

        if self.auth_token is not None:
            token = self.auth.verify(self.auth_token)
            if token is False:
